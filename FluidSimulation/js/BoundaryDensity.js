...
BoundaryDensity = function(res, camera) {
    this.res = res;
    this.camera = camera;
    ...
    var material = new THREE.ShaderMaterial({
        ...
        fragmentShader: document.getElementById( 'BoundaryDensity' ).innerHTML
    });
...
BoundaryDensity.prototype.process = function(renderer, bufferTexture, velocityField, face_bottom_left, face_up_right,
